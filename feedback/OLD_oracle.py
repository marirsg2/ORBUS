...
class oracle:
    ...
    def __init__(self,
        ...
        if rating_distribution == "uniform":
            ...
            power_law_samples = 1 - np.random.power(5, 10000)
        ...
        self.probability_per_level = probability_per_level
        self.l1_features_in_grid = journey_world.get_l1_features_in_grid()
        ...
        for current_feature_level, relevance_probability in zip(feature_level_list, probability_per_level):
            # features_at_current_level = combinations(self.l1_features_in_grid, current_feature_level)
            features_at_current_level = permutations(self.l1_features_in_grid, current_feature_level)
