...
high_freq_features = random.sample(set(s1_features).difference(chosen_features),num_high_freq)
chosen_features.update(high_freq_features)
for single_feat in high_freq_features:
