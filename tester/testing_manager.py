...
def test_full_cycle_and_accuracy(test_size, num_rounds, num_plans_per_round, random_sampling_enabled = False,
    ...
    for round_num in range(1,num_rounds+1):
        ...
        print("NUM OF SEEN RELEVANT FEATURES = ", manager.CONFIRMED_features_dimension)
        ...
        print("TESTING RANGE IS [0.1,0.9]")
        inRegion_bayes_error,UNALTERED_inRegion_bayes_error, inRegion_MLE_error,inRegion_true_values_and_diff = manager.region_based_evaluation(annotated_test_plans, [0.1,0.9],
...
if __name__ == "__main__":
    ...
    for i in range(15):
        ...
        special_order_cases = [ [False, True, False, False],[False, False, False, False]]# gain and discovery
